...
public class ExitWarrant extends JPanel implements ActionListener{
    ...
    public void setInitTable(){
        try {
            goods= sw.selectExitWarrant();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        if(goods.isEmpty()){
            JOptionPane.showMessageDialog(null, "出库单数据缺失", "ERROR!",JOptionPane.ERROR_MESSAGE);
            System.exit(1);
        }
        maxpage=goods.size();
        for(int i=0;i<18;i++){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //---- 打印 ----
            ...
            File jasperFile = new File("report/exit_warrant.jasper");
            String outPath = "report/exit_warrant.pdf";
